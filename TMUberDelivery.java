...
public class TMUberDelivery extends TMUberService
{
  ...
  public boolean equals(Object other)
  {
    ...
    if(newService.getServiceType().equals("DELIVERY")){
      TMUberDelivery newDelivery = (TMUberDelivery) newService;
      if(newDelivery.getRestaurant().equals(this.restaurant)&&newDelivery.getFoodOrderId().equals(this.foodOrderId)){
        return true;
      }
    }
    return false;
